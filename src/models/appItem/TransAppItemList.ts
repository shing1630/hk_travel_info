...
export class TransAppItemList {
    ...
    init() {
        ...
        transportAppItem.editorWordEN = 'Friendly user interface. Show estimated taxi fare before booking. Local people use it too.'
        transportAppItem.editorWordCN = '好的用户界面。预订前显示出租车费用。当地人也使用它。'
        transportAppItem.editorWordZH = '好的用戶界面。預訂前顯示出租車費用。當地人也使用它。'
