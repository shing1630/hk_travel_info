...
export class WeatherInfoItemList {
    ...
    init() {
        ...
        weatherInfoItem.info1DescEN = 'Occasional Fog and drizzle. Sometimes low visibility.'
        weatherInfoItem.info1DescCN = '间中有雾和毛毛雨，有时候能见度低。'
        weatherInfoItem.info1DescZH = '間中有霧和毛毛雨，有時候能見度低。'
        weatherInfoItem.info1Pic = 'https://vgy.me/zZDCXZ.jpg'
        weatherInfoItem.info2Flag = true
        weatherInfoItem.info2HdrEN = 'Summer (June to August)'
        weatherInfoItem.info2HdrCN = '夏天（六月至八月）'
        weatherInfoItem.info2HdrZH = '夏天（六月至八月）'
        weatherInfoItem.info2DescEN = 'Rainy season. Often showers and thunderstorms. Likely to be affected by tropical cyclones.'
        weatherInfoItem.info2DescCN = '雨季，常有骤雨和雷暴。可能受台风影响。'
        weatherInfoItem.info2DescZH = '雨季，常有驟雨和雷暴。可能受颱風影響。'
        ...
        weatherInfoItem.info4HdrCN = '冬天（十二月至二月）'
        weatherInfoItem.info4HdrZH = '冬天（十二月至二月）'
        weatherInfoItem.info4DescEN = 'The minimum rainfall season, but sometime with drizzle. '
        weatherInfoItem.info4DescCN = '全年最小雨量的季节，但间中也有毛毛雨。'
        weatherInfoItem.info4DescZH = '全年最小雨量的季節，但間中也有毛毛雨。'
